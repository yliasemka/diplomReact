const Spinner = () => {
    return(
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid" width="200" height="200" style={{ shapeRendering: 'auto', display: 'block', background: 'rgb(255, 255, 255)' , margin: "auto auto "}} xmlnsXlink="http://www.w3.org/1999/xlink"><g><circle fill="#ff0000" r="10" cy="50" cx="84">
            ...
            <animate begin="0s" values="#ff0000;#c1d82f;#ffdd00;#fbb034;#ff0000" keyTimes="0;0.25;0.5;0.75;1" calcMode="discrete" dur="1s" repeatCount="indefinite" attributeName="fill"></animate>
            </circle><circle fill="#ff0000" r="10" cy="50" cx="16">
            ...
            </circle><circle fill="#fbb034" r="10" cy="50" cx="50">
            ...
            </circle><circle fill="#ffdd00" r="10" cy="50" cx="84">
            ...
            </circle><circle fill="#c1d82f" r="10" cy="50" cx="16">
